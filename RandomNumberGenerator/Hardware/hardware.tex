...
\begin{abstract}
	Shift registers were used to create a random number generator for this assignment.
\end{abstract}
...
\section*{Procedure}
\begin{enumerate}
	\item We connected the 555 timer circuit like the figure \ref{555_t_c}
	\begin{figure}[h]
	...
	\item Then, in accordance with the table, we connected the seven segmented display and the dceoder (7447 IC) \ref{table} and the figure \ref{SSD}
	\begin{figure}[h]
...
\section*{Output} 
	Random numbers are generated on the display. \ref{output}
	\begin{figure}[h]
